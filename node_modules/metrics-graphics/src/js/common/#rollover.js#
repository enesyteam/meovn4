...
function mg_mouseover_text(args, rargs) {
  ...
  window.text_container = mg_reset_text_container(rargs.svg);

  window.mouseover_row = function(rargs) {
    var rrr = mg_mouseover_row(window.row_number, window.text_container, rargs);
    windmow.row_number += 1;
    return rrr;
  }
